...
class SettingsWidget(QWidget):
    ...
    def __init__(self):
        ...
        _settings_and_info_layout = QVBoxLayout()
        ...
        rect_select_layout: QVBoxLayout = self._construct_rect_select_layout()
        _settings_layout.addLayout(rect_select_layout)

        self._layout = QVBoxLayout(self)
        self._layout.addLayout(_settings_layout)
        self._layout.addWidget(self._btn_box)

        # hide advanced settings and disable override spin boxes initially
