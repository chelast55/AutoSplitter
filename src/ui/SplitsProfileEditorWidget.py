...
class SplitsProfileEditorWidget(QWidget):
    ...
    def __init__(self):
        ...
        _items_layout = QFormLayout()
        _items_layout.addRow("Game: ", self.le_game)
        _items_layout.addRow("Category:", self.le_category)
        _items_layout.addRow("Author:", self.le_author)
        _items_layout.addRow("Video:", self.le_video)
        self._layout.addLayout(_items_layout)
        self._layout.addWidget(self._btn_switch)
        self._layout.addWidget(self.tb_splits)
        self._layout.addWidget(self.te_comment)
